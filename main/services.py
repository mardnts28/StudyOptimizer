...
def generate_document_summary(text, file_name='Document', file_mimetype='application/octet-stream'):
    ...
    try:
        ...
        prompt = (
            ...
            "📄 <b>Summary of:</b> [A brief 1-2 sentence description of what the file is about]\n\n"
            ...
            "2. Use HTML tags (<b>) ONLY. Avoid bullets if possible; use numbers instead.\n"
            "3. ZERO space between a header and its output content (NO empty lines between title and text).\n"
            "4. ONE empty line between a section's end and the next header.\n"
            "5. Executive Highlights MUST be a numbered list.\n"
            f"TEXT CONTENT:\n{text[:12000]}"
        )
...
def generate_batch_synthesis(doc_ids, user):
    ...
    try:
        ...
        prompt = (
            ...
            "3. ZERO space between headers and their content (NO gaps).\n"
